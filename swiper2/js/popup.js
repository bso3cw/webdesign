$(document).ready(function(){
    ...
    /* 같은 버튼에 두 가지 효과
       ...
       2. if문으로 현재 play 상태인지 stop 상태인지 구분해서 적용하는 방법 (하나의 이벤트로) */
    $('.popup .btn_stop').on('click', function(){
        if($(this).hasClass('play') == true){ // 만약 현재 play class를 가지고 있다면 일시정지 중
    ...
    /* swiper를 하나의 페이지에 여러 개 적용하는 경우 반드시 const swiper의 이름을 변경해야 함. */
